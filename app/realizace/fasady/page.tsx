...
export const metadata: Metadata = { title: "Realizace Fasady | IceWood", description: "Ukázky realizací kategorie fasady." };

export default function Page() {
  const filtered = realizations.filter((r) => r.category === "fasady");
  return (
    <main>
      <Breadcrumbs items={[{ label: "Domů", href: "/" }, { label: "Realizace", href: "/realizace" }, { label: "Fasady" }]} />
      <PageHero title="Realizace – Fasady" description="Reference vybraných projektů v této kategorii." />
