...
export const metadata: Metadata = { title: "Realizace Terasy | IceWood", description: "Ukázky realizací kategorie terasy." };

export default function Page() {
  const filtered = realizations.filter((r) => r.category === "terasy");
  return (
    <main>
      <Breadcrumbs items={[{ label: "Domů", href: "/" }, { label: "Realizace", href: "/realizace" }, { label: "Terasy" }]} />
      <PageHero title="Realizace – Terasy" description="Reference vybraných projektů v této kategorii." />
